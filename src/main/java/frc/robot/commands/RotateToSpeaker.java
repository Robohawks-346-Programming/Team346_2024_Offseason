...
public class RotateToSpeaker extends Command {
	...
	public RotateToSpeaker(CommandSwerveDrivetrain drive) {
		...
		m_turnController = new PIDController(0.04, 0, 0);
	...
	public void execute() {
		m_drive.setControl(
				new SwerveRequest.FieldCentric()
						.withVelocityX(0)
						.withVelocityY(0)
						.withRotationalRate(m_turnController.calculate(m_drive.getPose().getRotation().getDegrees(),
								m_drive.getHeadingToSpeaker()))
